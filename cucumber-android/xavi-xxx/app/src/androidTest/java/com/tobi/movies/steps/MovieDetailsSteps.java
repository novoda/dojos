...
public class MovieDetailsSteps {
    ...
    @Given("^I open movie with id (\\d+)$")
    public void iOpenMovieWithId(int movieId) throws Throwable {
        posterDetailsRobot.launchDetailsScreen(movieId);
    }

    @Then("^I expect to see the release date \"([^\"]*)\"$")
    public void iExpectToSeeTheReleaseDate(String releaseDate) throws Throwable {
